...
class SavingAccount extends BankAccount {
    constructor(accountNo, accountHolder, balance) {
        ...
        this._interestRate = 0.05; // Assuming 5% interest rate
        this._withdrawalLimit = 3; // Assuming 3 withdrawals are allowed per month
    ...
    withdraw(amount) {
        if (this._withdrawalCount < this._withdrawalLimit) {
            ...
            super.withdraw(amount + 10); // Penalty fee of 10 units
        }
    }
}
